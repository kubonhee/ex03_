...
<jsp:include page="../includes/header.jsp" />
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form method="post" class="needs-validation" novalidate> <!-- 1개의 input type="text" name="bno", value값 지정, readonly -->
	                        ...
	                        <div class="form-group">
					      		...
					      		<textarea class="form-control" rows="10" id="content" placeholder="게시글 내용을 입력하세요." name="content" required readonly>${board.content}</textarea>
					      		<div class="valid-feedback">Valid.</div>
      							<div class="invalid-feedback">Please fill out this field.</div>
					   		</div>
	                        <div class="form-group">
                ...
                <script>
                	...
                	replyService.remove(81, function(result) {
                		alert(result); 
                	}, function(err) {
                		alert("삭제 실패");
                	});
